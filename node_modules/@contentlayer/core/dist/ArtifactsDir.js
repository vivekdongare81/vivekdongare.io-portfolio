...
(function (ArtifactsDir) {
    ...
    ArtifactsDir.mkdir = T.gen(function* ($) {
        ...
        yield* $(fs.mkdirp(dirPath), fileName_1 + ":19:13");
        return dirPath;
    }, fileName_1 + ":16:92");
    ArtifactsDir.getCacheDirPath = (T.map_(T.struct({
        contentlayerVersion: getContentlayerVersion(),
        cwd: getCwd,
    }, fileName_1 + ":25:13"), ({ contentlayerVersion, cwd }) => filePathJoin(ArtifactsDir.getDirPath({ cwd }), '.cache', `v${contentlayerVersion}`), fileName_1 + ":29:10"));
    ArtifactsDir.mkdirCache = (T.tap_(ArtifactsDir.getCacheDirPath, fs.mkdirp, fileName_1 + ":35:32"));
